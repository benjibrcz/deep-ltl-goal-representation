...
def main():
    ...
    p.add_argument('--out',         type=str, default='agent_location_probe.png')
    args = p.parse_args()
    ...
    axes[0].set_title('Scatter: True vs Predicted Agent Positions (Test)')
    ...
    axes[1].set_title('Trajectory: True vs Predicted (Test)')
    ...
    print(f"\nSaved agent location probe plot to {args.out}")
