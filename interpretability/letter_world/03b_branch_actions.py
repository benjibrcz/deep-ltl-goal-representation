...
def main():
    ...
    ap.add_argument('--features', type=str, default='obs_local_flat,obs_conv', help='Comma list: obs_local_flat,obs_conv,obs_emb,actor_prelogits')
    ...
    data = {k: [] for k in ['obs_raw', 'feature', 'feature_base', 'action', 'next_obs_raw', 'branched_action', 'episode', 'agent_pos', 'agent_pos_next', 'ego_now', 'ego_next', 'source_id']}
